        ...
        foreach ($data['events'] as $event){
                ...
                if(strtolower($textmessageFromUser) == "buah"){
                    ...
                    $carouselTemplateBuilder = new CarouselTemplateBuilder([
                        new CarouselColumnTemplateBuilder("Apel", "text","https://i.ibb.co/MnmMzfr/apel.jpg",
                    [
                        new UriTemplateActionBuilder('lebih lanjut',"https://cerpin.com/alasan-penting-untuk-makan-apel/"),
                    ]),
                        new CarouselColumnTemplateBuilder("Jeruk", "text","https://i.ibb.co/g43x0ZD/jeruk.jpg",
                    [
